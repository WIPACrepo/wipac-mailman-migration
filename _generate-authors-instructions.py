...
#            paras.append(no_change_can_skip)
        ...
        If you believe our records are incorrect, please have your
        ...
        if effective_address_change:
            ...
            breadcrumbs.append('eff_addr_change')
            ...
            if in_auth or in_auth_gen2:
                ...
                Note that you will be subscribed using {display_sub_addr}."""
        ...
        mailing lists whose management will be automated."""
